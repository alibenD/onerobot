...
onebot: https://github.com/alibenD/onebot
...
def generate_launch_description():
    ...
    package_name_description = 'onebot_description'
    package_name_bringup = 'onebot_bringup'

    default_robot_name = 'onebot'
    gazebo_models_path = 'models'
    default_world_file = 'empty.world'
    gazebo_worlds_path = 'worlds'
    ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml'
    rviz_config_filename = 'onebot_gazebo_sim.rviz'
