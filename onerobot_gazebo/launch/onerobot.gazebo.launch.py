...
onerobot: https://github.com/alibenD/onerobot
...
def generate_launch_description():
    ...
    package_name_description = 'onerobot_description'
    package_name_bringup = 'onerobot_bringup'

    default_robot_name = 'onerobot'
    gazebo_models_path = 'models'
    default_world_file = 'empty.world'
    gazebo_worlds_path = 'worlds'
    ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml'
    rviz_config_filename = 'onerobot_gazebo_sim.rviz'
