...
def process_ros2_controllers_config(context):
    ...
    package_share_description = get_package_share_directory('onebot_description')
    ...
    src_config_path = os.path.join(
        ...
        #'config',
        home,
        'project/onebot_ws/src/onebot/onebot_description/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='onebot',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'onebot_description'
    urdf_filename = 'onebot.urdf.xacro'
    rviz_config_filename = 'onebot_description.rviz'
