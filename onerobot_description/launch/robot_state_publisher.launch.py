...
def process_ros2_controllers_config(context):
    ...
    package_share_description = get_package_share_directory('onerobot_description')
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='onerobot',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'onerobot_description'
    urdf_filename = 'onerobot.urdf.xacro'
    rviz_config_filename = 'onerobot_description.rviz'
