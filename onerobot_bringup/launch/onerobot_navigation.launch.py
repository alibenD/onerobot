...
def generate_launch_description():
    ...
    package_name_docking = 'onerobot_docking'
    package_name_gazebo = 'onerobot_gazebo'
    package_name_localization = 'onerobot_localization'
    package_name_navigation = 'onerobot_navigation'

    # Launch and config file paths
    apriltag_launch_file_path = 'launch/apriltag_dock_pose_publisher.launch.py'
    gazebo_launch_file_path = 'launch/onerobot.gazebo.launch.py'
