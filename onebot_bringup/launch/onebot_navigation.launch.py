...
def generate_launch_description():
    ...
    package_name_docking = 'onebot_docking'
    package_name_gazebo = 'onebot_gazebo'
    package_name_localization = 'onebot_localization'
    package_name_navigation = 'onebot_navigation'

    # Launch and config file paths
    apriltag_launch_file_path = 'launch/apriltag_dock_pose_publisher.launch.py'
    gazebo_launch_file_path = 'launch/onebot.gazebo.launch.py'
